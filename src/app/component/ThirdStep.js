        ...
        <div className='flex flex-col flex-grow justify-between'>
          ...
          <div>
            ...
            <div className='flex flex-col items-center justify-center gap-y-2 cursor-pointer bg-gray-100 h-[180px] border rounded-md border-solid mt-[8px]'>
              <div className='bg-white rounded-full w-7 h-7 flex items-center justify-center' type='file'>
          ...
          <div className='flex w-full gap-x-2 mt-[70px]'>
            ...
            <button onClick={handleFormNextStep} className='flex flex-1 items-center justify-center h-[44px] gap-x-3 rounded-md bg-[#121316] text-white transition-all duration-300 hover:opacity-80'> <span>Continue 3/3</span> </button>
          </div>
        </div>
      </div>
    </div>
